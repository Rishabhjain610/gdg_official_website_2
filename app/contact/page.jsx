...
import { IoMailOutline, IoLocationOutline, IoLogoLinkedin, IoSend } from 'react-icons/io5';
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
            ...
            <div className="space-y-4">
              <Link href="https://www.linkedin.com/company/gdg-tsec/?originalSubdomain=in" target="_blank" 
                ...
                <div>
                  ...
                  <div className="text-blue-300 text-sm">Follow our updates</div>
                </div>
              </Link>

              <Link href="mailto:dsctsec@gmail.com" 
              ...
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-green-500/10 border border-green-500/20">
                ...
                <div>
                  ...
                  <div className="text-green-300 text-sm">TSEC, Bandra West, Mumbai</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full font-bold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-3 ${
                  status === 'loading' ? 'bg-gray-600 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 hover:scale-[1.02]'
                }`}
              >
                {status === 'loading' ? (
                  <>
