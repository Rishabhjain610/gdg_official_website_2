...
const iconComponents = {
  blacksimba: {
    component: () => (
      <Image src="/logos/Black Simba.png" alt="Black Simba" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#FF6B35'
  },
  collegepond: {
    component: () => (
      <Image src="/logos/Collegepond.webp" alt="College Pond" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#4A90E2'
  },
  devfolio: {
    component: () => (
      <Image src="/logos/Devfolio.png" alt="Devfolio" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#00D4AA'
  },
  ethindia: {
    component: () => (
      <Image src="/logos/ETHIndia.png" alt="ETH India" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#8B5CF6'
  },
  fra: {
    component: () => (
      <Image src="/logos/FRA.png" alt="FRA" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#EF4444'
  },
  fyregig: {
    component: () => (
      <Image src="/logos/Fyre GIG.png" alt="Fyre Gig" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#F59E0B'
  },
  redfox: {
    component: () => (
      <Image src="/logos/Redfox-Security.png" alt="Redfox Security" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#DC2626'
  },
  taskade: {
    component: () => (
      <Image src="/logos/Taskade.png" alt="Taskade" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#3B82F6'
  },
  tcglobal: {
    component: () => (
      <Image src="/logos/TC Global.jpg" alt="TC Global" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#10B981'
  },
  thedevarmy: {
    component: () => (
      <Image src="/logos/theDevArmy.png" alt="The Dev Army" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#6366F1'
  },
  unstop: {
    component: () => (
      <Image src="/logos/Unstop.png" alt="Unstop" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#8B5CF6'
  },
  wolfram: {
    component: () => (
      <Image src="/logos/Wolfram.png" alt="Wolfram" width={36} height={36} className="w-full h-full object-contain" />
    ),
    color: '#E879F9'
  }
};
...
// Mobile config (smaller radii and sizes)
const skillsConfigMobile = [
  { id: 'blacksimba', orbitRadius: 60, size: 40, speed: 0.5, iconType: 'blacksimba', phaseShift: 0, glowColor: 'red', label: 'Black Simba' },
  { id: 'collegepond', orbitRadius: 60, size: 44, speed: 0.5, iconType: 'collegepond', phaseShift: 2 * Math.PI / 3, glowColor: 'red', label: 'College Pond' },
  { id: 'devfolio', orbitRadius: 60, size: 40, speed: 0.5, iconType: 'devfolio', phaseShift: 4 * Math.PI / 3, glowColor: 'red', label: 'Devfolio' },
  { id: 'ethindia', orbitRadius: 90, size: 48, speed: -0.3, iconType: 'ethindia', phaseShift: 0, glowColor: 'blue', label: 'ETH India' },
  { id: 'fra', orbitRadius: 90, size: 44, speed: -0.3, iconType: 'fra', phaseShift: 2 * Math.PI / 3, glowColor: 'blue', label: 'FRA' },
  { id: 'fyregig', orbitRadius: 90, size: 40, speed: -0.3, iconType: 'fyregig', phaseShift: 4 * Math.PI / 3, glowColor: 'blue', label: 'Fyre Gig' },
  { id: 'redfox', orbitRadius: 120, size: 44, speed: 0.4, iconType: 'redfox', phaseShift: 0, glowColor: 'green', label: 'Redfox Security' },
  { id: 'taskade', orbitRadius: 120, size: 40, speed: 0.4, iconType: 'taskade', phaseShift: 2 * Math.PI / 3, glowColor: 'green', label: 'Taskade' },
  { id: 'tcglobal', orbitRadius: 120, size: 44, speed: 0.4, iconType: 'tcglobal', phaseShift: 4 * Math.PI / 3, glowColor: 'green', label: 'TC Global' },
  { id: 'thedevarmy', orbitRadius: 150, size: 40, speed: -0.25, iconType: 'thedevarmy', phaseShift: 0, glowColor: 'yellow', label: 'The Dev Army' },
  { id: 'unstop', orbitRadius: 150, size: 44, speed: -0.25, iconType: 'unstop', phaseShift: 2 * Math.PI / 3, glowColor: 'yellow', label: 'Unstop' },
  { id: 'wolfram', orbitRadius: 150, size: 40, speed: -0.25, iconType: 'wolfram', phaseShift: 4 * Math.PI / 3, glowColor: 'yellow', label: 'Wolfram' }
];
...
export default function OrbitingSkills() {
  ...
  // Responsive orbit configs
  const orbitConfigs = isMobile
    ? [
        { radius: 60, glowColor: 'red', delay: 0 },
        { radius: 90, glowColor: 'blue', delay: 1.5 },
        { radius: 120, glowColor: 'green', delay: 0.5 },
        { radius: 150, glowColor: 'yellow', delay: 2.0 }
      ]
    : [
        { radius: 120, glowColor: 'red', delay: 0 },
        { radius: 180, glowColor: 'blue', delay: 1.5 },
  ...
  const skillsConfig = isMobile ? skillsConfigMobile : skillsConfigDesktop;

  return (
    <main className="w-full h-full flex items-center justify-center overflow-hidden bg-transparent">
      <div
      ...
      >
        {/* Center logo */}
        <div className="w-16 h-16 md:w-20 md:h-20 bg-transparent rounded-full flex items-center justify-center z-10 relative shadow-2xl">
          <div className="absolute inset-0 rounded-full blur-xl animate-pulse"></div>
          <div
